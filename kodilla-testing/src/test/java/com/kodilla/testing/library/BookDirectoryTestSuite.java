...
public class BookDirectoryTestSuite {
    ...
    void testListBooksInHandsOf() {
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser userWith0Books = new LibraryUser("Jan", "Kowalski", "80010100111");
        LibraryUser userWith1Book = new LibraryUser("Pawel", "Nowak", "85020200112");
        LibraryUser userWith5Books = new LibraryUser("Katarzyna", "Kot", "90030300113");
